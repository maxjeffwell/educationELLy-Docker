    ...
    <StyledContainer>
      <div style={{ textAlign: 'center', marginBottom: '40px' }}>
        ...
        <p style={{ fontSize: '1.2em' }}>
          Manage your English Language Learning students, track progress, and
          organize your teaching workflows.
        </p>
      </div>
          ...
          <ActionLink to="/students">
            <StyledSegment>
              ...
              <p style={{ textAlign: 'center' }}>
                Access your complete list of students. View profiles, track
                progress, and manage ELL status.
              </p>
            </StyledSegment>
          </ActionLink>
        </Grid.Column>
        ...
        <Grid.Column>
          <ActionLink to="/students/new">
            <StyledSegment>
              ...
              <p style={{ textAlign: 'center' }}>
                Register a new student to your ELL program. Input demographics,
                initial levels, and assignments.
              </p>
            </StyledSegment>
          </ActionLink>
        </Grid.Column>
